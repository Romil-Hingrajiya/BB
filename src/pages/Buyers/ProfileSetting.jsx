...
import { FaUser, FaSignOutAlt, FaTachometerAlt, FaUpload } from "react-icons/fa";
        ...
        >
          ...
          <nav className="space-y-4">
            ...
            >
              <span
                className={`text-lg font-semibold flex items-center ${
                  currentPath === "/buyer-profile" ? "text-white" : "text-orange-500"
                }`}
              >
                  ...
                  <div className="flex flex-col items-start space-y-2">
                    ...
                    <div className="w-full flex items-center bg-white/95 text-black rounded-md shadow-inner shadow-gray-700 hover:bg-white transition-all duration-150 px-4 py-3 mb-4">
                      <input
                        type="text"
                        placeholder="Address"
                        className="bg-transparent outline-none w-full placeholder:text-gray-500 text-base py-2"
                      />
                    </div>
                  </div>
                </div>
